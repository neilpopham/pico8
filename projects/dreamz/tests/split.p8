...
data="8,1,2,3,4,5,6,7,8,9;5,10,20,30,40,50,60"
dumptable(keywithfixedlengths(data,3))

data="8,1,2,3,5,10,20,30"
dumptable(keywithfixedlength(data,3))

data="1,2,3,4,5,6,7,8,9"
dumptable(fixedlength(data,3))