   ...
   if self:collide_object(p) then
    ...
    for _,d in pairs(drops.items) do
     if d.type==self.type then
      if self.type>1
      or (self.type==1 and p.bombs==5)
      or (self.type==4 and p.damage==p.max.damage) then 
       d:destroy()
      end
     end
    end
...
00000000000000000000000055533ddd0533dd6005dd3bd0000000000000000000000000000000000000000000000000cc777cc00ddc670000ddd000066cdd00
